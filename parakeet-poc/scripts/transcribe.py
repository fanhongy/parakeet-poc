...
def transcribe(input_key: str) -> dict:
    ...
    for i, chunk in enumerate(chunks):
        ...
        # Handle nested list structure from NeMo transcribe
        ...
        if self.path == '/transcribe':
            ...
            try:
                ...
                try:
                    ...
                    print(f"Client disconnected before response sent (result already saved to S3)", flush=True)
            except BrokenPipeError:
                print(f"Client disconnected during processing (broken pipe)", flush=True)
                ...
                try:
                    ...
                    print(f"Client disconnected before error response sent", flush=True)
        else:
